...
description: "Meta-skill for designing orchestrator+phases structured workflow skills"
category: "api"
locale: "en"
order: 14
---
...
| **Tools** | `Task`, `AskUserQuestion`, `TodoWrite`, `Read`, `Write`, `Edit`, `Bash`, `Glob`, `Grep` |
