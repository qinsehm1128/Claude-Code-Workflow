...
description: "Generate interactive TiddlyWiki-style HTML software manuals with screenshots, API docs, and multi-level code examples"
category: "api"
locale: "en"
order: 13
---
...
| **Tools** | `Task`, `AskUserQuestion`, `Read`, `Bash`, `Glob`, `Grep`, `Write`, `mcp__chrome__*` |
