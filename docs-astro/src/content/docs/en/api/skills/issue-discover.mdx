...
description: "Unified issue discovery and creation"
category: "api"
locale: "en"
order: 5
---
...
|----------|-------|
| **Name** | `issue-discover` |
| **Tools** | `Task`, `AskUserQuestion`, `TodoWrite`, `Read`, `Write`, `Edit`, `Bash`, `Glob`, `Grep`, `Skill`, `mcp__ace-tool__search_context`, `mcp__exa__search` |
