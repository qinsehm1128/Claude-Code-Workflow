...
description: "Intelligent context collector for development tasks. Executes multi-layer file discovery, dependency analysis, and generates standardized context packages wi..."
category: "api"
locale: "en"
order: 11
---
...
| **Color** | blue |
| **Tools** | `Bash`, `Glob`, `Grep`, `Read`, `mcp__exa__get_code_context_exa`, `mcp__exa__web_search_exa` |
